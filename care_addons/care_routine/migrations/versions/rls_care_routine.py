"""เปิด RLS ให้ตารางของ care_routine — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_routine
Revises: 96a5a96b099c
...
revision = "rls_care_routine"
down_revision = "96a5a96b099c"
branch_labels = None
depends_on = None

TABLES = ['care_routine_item']
