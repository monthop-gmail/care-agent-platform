"""เปิด RLS ให้ตารางของ care_patient — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_patient
Revises: 1c01e2d79662
...
revision = "rls_care_patient"
down_revision = "1c01e2d79662"
branch_labels = None
depends_on = None

TABLES = ['care_patient', 'care_caregiver', 'care_team_member']
