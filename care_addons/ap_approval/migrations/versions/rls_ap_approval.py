"""เปิด RLS ให้ตารางของ ap_approval — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_ap_approval
Revises: 0001_approval_initial
...
revision = "rls_ap_approval"
down_revision = "0001_approval_initial"
branch_labels = None
depends_on = None

TABLES = ['ap_approval_request', 'ap_approval']
