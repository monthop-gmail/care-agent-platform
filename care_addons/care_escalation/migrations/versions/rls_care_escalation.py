"""เปิด RLS ให้ตารางของ care_escalation — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_escalation
Revises: dbcd7519fc5e
...
revision = "rls_care_escalation"
down_revision = "dbcd7519fc5e"
branch_labels = None
depends_on = None

TABLES = ['care_job', 'care_notification']
