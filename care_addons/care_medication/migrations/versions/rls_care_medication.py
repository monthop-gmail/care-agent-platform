"""เปิด RLS ให้ตารางของ care_medication — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_medication
Revises: 412f2a69227b
...
revision = "rls_care_medication"
down_revision = "412f2a69227b"
branch_labels = None
depends_on = None

TABLES = ['care_medication_version']
