"""เปิด RLS ให้ตารางของ care_careplan — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_careplan
Revises: 0001_careplan_initial
...
revision = "rls_care_careplan"
down_revision = "0001_careplan_initial"
branch_labels = None
depends_on = None

TABLES = ['care_careplan_task']
