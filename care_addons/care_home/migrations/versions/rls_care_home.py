"""เปิด RLS ให้ตารางของ care_home — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_home
Revises: 0001_home_initial
...
revision = "rls_care_home"
down_revision = "0001_home_initial"
branch_labels = None
depends_on = None

TABLES = ['care_home_item']
