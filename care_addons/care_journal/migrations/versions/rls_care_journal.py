"""เปิด RLS ให้ตารางของ care_journal — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_journal
Revises: 713a7af12c06
...
revision = "rls_care_journal"
down_revision = "713a7af12c06"
branch_labels = None
depends_on = None

TABLES = ['care_journal_entry']
