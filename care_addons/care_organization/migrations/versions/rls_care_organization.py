"""เปิด RLS ให้ตารางของ care_organization — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_organization
Revises: 0001_organization_initial
...
revision = "rls_care_organization"
down_revision = "0001_organization_initial"
branch_labels = None
depends_on = None

TABLES = ['care_organization', 'care_org_membership']
