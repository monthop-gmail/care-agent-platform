"""เปิด RLS ให้ตารางของ care_orchestrator — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_orchestrator
Revises: 0001_orchestrator_initial
...
revision = "rls_care_orchestrator"
down_revision = "0001_orchestrator_initial"
branch_labels = None
depends_on = None

TABLES = ['care_daily_summary']
