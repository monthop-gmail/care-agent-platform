"""เปิด RLS ให้ตารางของ care_activity — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_activity
Revises: 0001_activity_initial
...
revision = "rls_care_activity"
down_revision = "0001_activity_initial"
branch_labels = None
depends_on = None

TABLES = ['care_activity', 'care_activity_step']
