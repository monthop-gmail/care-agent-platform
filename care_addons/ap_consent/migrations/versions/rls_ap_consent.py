"""เปิด RLS ให้ตารางของ ap_consent — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_ap_consent
Revises: 0001_consent_initial
...
revision = "rls_ap_consent"
down_revision = "0001_consent_initial"
branch_labels = None
depends_on = None

TABLES = ['ap_consent_grant']
