"""เปิด RLS ให้ตารางของ care_safety — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_safety
Revises: 0001_safety_initial
...
revision = "rls_care_safety"
down_revision = "0001_safety_initial"
branch_labels = None
depends_on = None

TABLES = ['care_safety_event']
