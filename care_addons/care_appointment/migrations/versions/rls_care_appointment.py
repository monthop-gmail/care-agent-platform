"""เปิด RLS ให้ตารางของ care_appointment — ด่านที่สองตาม MODULE_GUIDE §9

Revision ID: rls_care_appointment
Revises: 30ed34858f6d
...
revision = "rls_care_appointment"
down_revision = "30ed34858f6d"
branch_labels = None
depends_on = None

TABLES = ['care_appointment', 'care_preparation_step']
